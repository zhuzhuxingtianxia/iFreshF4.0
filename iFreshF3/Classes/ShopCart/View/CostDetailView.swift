...
class CostDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let lineView1 = UIView(frame: CGRect(x:15,y:30 - 0.5,width:ZJScreenWidth - 15,height:0.5))
        ...
        buildLabel(labelFrame: CGRect(x:100, y:35, width:ZJScreenWidth - 110, height:20), text: "$" + UserShopCarTool.sharedUserShopCar.getAllProductsPrice(), font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:60, width:ZJScreenWidth - 110, height:20), text: "$" + distribution!, font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:85, width:ZJScreenWidth - 110, height:20), text: "$0", font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:110, width:ZJScreenWidth - 110, height:20), text: "$" + coupon!, font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        
        let lineView2 = UIView(frame: CGRect(x:0, y:135 - 1, width:ZJScreenWidth, height:1))
