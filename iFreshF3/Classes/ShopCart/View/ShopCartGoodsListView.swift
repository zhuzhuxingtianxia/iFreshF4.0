...
class ShopCartGoodsListView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        for i in 0..<goodses.count {
            let goods = goodses[i]
            buildLineView(lineFrame: CGRect(x:15, y:lastViewY, width:ZJScreenWidth - 15, height:0.5))
            
            if goods.pm_desc != "买一赠一" {
                let goodsDetailView = PayGoodsDetailView(frame: CGRect(x:0,y:lastViewY + 10,width:ZJScreenWidth,height:20))
                ...
                let giftView = PayGoodsDetailView(frame: CGRect(x:0,y:lastViewY,width:ZJScreenWidth,height:20))
                goods.pm_desc = "买一赠一"
        ...
        let lineView = UIView(frame: CGRect(x:15,y:lastViewY - 0.5, width:ZJScreenWidth - 15,height:0.5))
        ...
        let finePriceLabel = UILabel(frame: CGRect(x:50,y:lastViewY,width:ZJScreenWidth - 60,height:40))
        ...
        let lineView1 = UIView(frame: CGRect(x:0,y:goodsHeight - 1, width:ZJScreenWidth,height:1))
...
class PayGoodsDetailView: UIView {
    ...
    override func layoutSubviews() {
        ...
        if isShowImageView {
            ...
            numberLabel.frame = CGRect(x:ZJScreenWidth * 0.7, y:0, width:50, height:height)
        }else{
