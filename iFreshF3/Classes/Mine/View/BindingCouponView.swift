...
class BindingCouponView: UIView {
    ...
    private lazy var couponTextFiled: UITextField = {
        ...
        let placeholder = NSAttributedString(string: "请输入优惠劵号码", attributes: [NSAttributedStringKey.font : UIFont.systemFont(ofSize: 14), NSAttributedStringKey.foregroundColor : UIColor(red: 50 / 255.0, green: 50 / 255.0, blue: 50 / 255.0, alpha: 0.8)])
