...
class SystemMessageCell: UITableViewCell {
    ...
    var message: UserMessage? {
        didSet {
            ...
            attStr.addAttribute(NSAttributedStringKey.paragraphStyle, value:attStyle, range: NSMakeRange(0, leng))
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        showMoreButton!.addTarget(self, action: #selector(SystemMessageCell.showMoreButtonClick(_:)), for: UIControlEvents.touchUpInside)
        showMoreButton?.isHidden = true
    ...
    override func layoutSubviews() {
        ...
        if showMoreButton!.isSelected == false {
    ...
    @objc func showMoreButtonClick(_ button: UIButton) {
