...
class CouponCell: UITableViewCell {
    ...
    let useColor = UIColor.colorWithRGB(r: 161, g: 120, b: 90)
    let unUseColor = UIColor.colorWithRGB(r: 158, g: 158, b: 158)
    ...
    var coupon: Coupon? {
        didSet {
            ...
            priceLabel?.text = "$" + (coupon!.value?.cleanDecimalPointZero())!
    ...
    private let circleWidth: CGFloat = ZJScreenWidth * 0.16
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        statusLabel?.textColor = UIColor.colorWithRGB(r: 105, g: 105, b: 105)
    ...
    override func layoutSubviews() {
        ...
        backImageView?.frame = CGRect(x:CouponViewControllerMargin, y:5, width:width - 2 * CouponViewControllerMargin, height:height - 10)
         ...
         let circleX = ((ZJScreenWidth - 2 * CouponViewControllerMargin) / 3 - circleWidth) * 0.35 + CouponViewControllerMargin
        circleImageView?.frame = CGRect(x:circleX, y:0, width:circleWidth, height:circleWidth)
        circleImageView?.center.y = backImageView!.center.y
        
        let starRightL: CGFloat = (ZJScreenWidth - 2 * CouponViewControllerMargin) * 0.26 + CouponViewControllerMargin
        let rightWidth: CGFloat = (ZJScreenWidth - 2 * CouponViewControllerMargin) * 0.74
        ...
        line1View?.frame = CGRect(x:CouponViewControllerMargin + (ZJScreenWidth - 2 * CouponViewControllerMargin) * 0.26 + 10, y:2, width:(ZJScreenWidth - 2 * CouponViewControllerMargin) * 0.74 - 20, height:0.8)
    ...
    private func setCouponColor(isUse: Bool) {
        ...
        titleLabel?.backgroundColor = isUse ? UIColor.colorWithRGB(r: 255, g: 244, b: 224) : UIColor.colorWithRGB(r: 238, g: 238, b: 238)
        ...
        tmpView.backgroundColor = isUse ? LFBNavigationYellowColor : UIColor.colorWithRGB(r: 210, g: 210, b: 210)
